...
const Header = (): JSX.Element => {
  return (
    <>
      <header className="bg-gradient-shopee-b pb-7 text-white text-sm m-and-t:[height:var(--header-mobile-height)] m-and-t:flex m-and-t:items-center m-and-t:pb-0 m-and-t:fixed m-and-t:fixed-top-all-width m-and-t:z-50">
        <HeaderNavbar className="gridLayout m-and-t:hidden pt-2 pb-6" />
        <div className="gridLayout w-full flex gap-2 justify-between items-end mobile:items-center mobile:px-3">
          <Link
            className="tablet:hidden w-1/6 pr-6 mobile:w-[162px] mobile:pr-0"
            aria-label="home"
            href={"#"}>
