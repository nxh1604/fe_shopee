  ...
  return (
    <header
      className={clsx(
        ...
        "m-and-t:transition-[transform] m-and-t:duration-300 m-and-t:ease-in-out m-and-t:[height:var(--header-mobile-height)] m-and-t:items-center m-and-t:pb-0 m-and-t:fixed m-and-t:fixed-top-all-width m-and-t:z-50"
      )}
    >
      {children}
    </header>
