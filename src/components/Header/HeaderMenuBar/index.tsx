...
const HeaderMenuBar = ({ classNameMenuContent, classNameMenu }: { classNameMenuContent?: string; classNameMenu?: string }) => {
  ...
  return (
    <>
      ...
      {isOpen &&
        createPortal(
          <>
            <div onClick={() => setIsOpen(false)} className="fixed top-0 right-0 left-0 bottom-0 bg-black/20 fade-in-animation z-50" />
            <div
              className={clsx(
