...
const NavItemHasDropdown = (props: React.PropsWithChildren<{ href: string; title: string }>) => {
  const { href, title } = props;

  return (
    <DropdownWrapper>
      <DropdownHover>
        <li className="hover:opacity-80 border-l-2 pl-3 border-slate-300 ">
...
const NavItem = (props: React.PropsWithChildren<{ href: string; title: string; className?: string }>) => {
