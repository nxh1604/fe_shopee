          ...
          <section className="col-12px w-5/12">
            ...
            <div className="relative mt-4">
              ...
              <ul className="flex gap-2 *:w-1/5">
                <li className="border-red-500 border-4">
                  <img src={product.src} alt="" width={150} height={150} className="w-full object-contain" />
                </li>
                <li>
                  <img src="https://placewaifu.com/image/300" alt="" width={150} height={150} className="w-full object-contain" />
                </li>
                <li>
                  <img src="https://placewaifu.com/image/300" alt="" width={150} height={150} className="w-full object-contain" />
                </li>
              ...
              <button aria-label="next image" className="text-white absolute  hover:bg-black/50 right-0 top-[50%] translate-y-[-50%] bg-black/5 py-2">
          ...
          <section className="col-12px flex-1 flex flex-col justify-start gap-8">
            ...
            <div>
              ...
              <div className="bg-primaryBgColor p-3 flex gap-4 items-center rounded-sm">
                ...
                <div className="uppercase bg-red-500 text-white px-1 rounded-sm text-xs font-bold">{product.discount}% giảm</div>
              </div>
            </div>

            <div className={clsx("pl-3 flex-1 flex flex-col pb-[30px] text-sm", sections.length < 3 ? "justify-around" : "justify-between")}>
