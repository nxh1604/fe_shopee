        ...
        <div className="flex-1">
          <div className="flex justify-between items-center text-sm">
            <div className="flex gap-1 items-center ">
              ...
              <Button onClick={() => setIsActive(true)} variant={isActive ? "primary" : "normal-no-hover"} size="small">
                Phổ biến
              </Button>
            ...
            <div className="flex gap-4 self-stretch">
              ...
              <div className="flex">
                <Button
                  className={twMerge(`border-r-[2px] border-primaryBgColor`, "disabled:cursor-default disabled:bg-primaryBgColor")}
                  disabled={page < 2}
                  size="Xsmall"
                >
                  <MdOutlineKeyboardArrowLeft />
                </Button>
                <Button size="Xsmall" className="disabled:cursor-default disabled:bg-primaryBgColor" disabled={page >= 9}>
