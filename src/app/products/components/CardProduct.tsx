...
const CardProduct = ({ src, title, discount, price, shop, location, rating, sold }: IProduct) => {
  ...
  return (
    <div className="pt-[10px] px-[5px] w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 xs:w-[100%]">
      <li className=" bg-white cursor-pointer translate-x-0 transition-[transform] rounded-t-[3px] duration-100 ease-linear hover:-translate-y-[2px] shadow hover:shadow-xl rounded-b-[2px]">
